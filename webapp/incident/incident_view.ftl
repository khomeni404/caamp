    ...
    <div class="col-xs-6">
        <div class="profile-user-info profile-user-info-striped">
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable" id="country">${TU.getIncidentType(inc.type?string)!}</span>
                </div>
            </div>
...
<div class="row text-right">
    <div class="col-lg-12">
        <button class="btn btn-white btn-info btn-bold" onclick="window.location = '${ctx}/incident/createIncidentReview.se?incidentId=${inc.id}'">
            <i class="ace-icon fa fa-flag-checkered bigger-120 blue"></i>
            Create Review
        </button>
        <button class="btn btn-white btn-info btn-bold" onclick="window.location = '${ctx}/incident/editIncident.se?id=${inc.id}'">
