...
<div class="row">
    <div class="col-xs-12">
        ...
        <form action="${ctx}/incident/saveIncidentReview.se" method="POST" class="form-horizontal" role="form">
           <input type="hidden" name="incidentId" value="${inc.id!}"/>
            ...
            <div class="col-lg-12 text-right">
                <button class="btn btn-white btn-info btn-bold"
                        onclick="window.location = '${ctx}/incident/createIncidentReview.se?incidentId=${inc.id}'">
