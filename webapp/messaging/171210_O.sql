...
CREATE TABLE `ad_project` (
  ...
  `sess_end` date DEFAULT NULL,
  `sess_start` date DEFAULT NULL,
...
insert  into `ad_project`(`code`,`rural_amt_m`,`urban_amt_m`,`rural_amt_ot`,`urban_amt_ot`,`sub_code`,`s_date`,`s_no`,`sess_duration`,`sess_end`,`sess_start`,`title`,`total_bene`) values ('201602',2000,2000,3000,3000,'00','2017-09-11','Board Memo.250',24,'2018-06-30','2016-01-07','Islami Bank Scholarship HSC-2016',1500),('201603',6000,5500,15000,10000,'00','2017-09-11','Board Memo.',2,'2020-12-31','2017-01-07','Islami Bank Scholarship (Graduation Level)-2016',2000);
...
insert  into `app_application`(`id`,`aiOK`,`applicantId`,`applyDate`,`closeDate`,`eiOK`,`fiOK`,`oiOK`,`open`,`piOK`,`branch_br_code`,`district_id`,`familyInfo_id`,`personalInfo_id`,`project_code`,`student_id`,`applicant_id`,`br_code`,`family_info_id`,`personal_info_id`) values (1,'\0',NULL,'2017-12-08 14:12:43',NULL,'\0','\0','\0','','\0',NULL,44,NULL,NULL,NULL,12,'717659287','143',NULL,NULL);
...
insert  into `com_address_master`(`type`,`id`,`line1`,`line2`,`note`,`pc`,`po`,`application_id`,`ps_id`) values ('Present',1,'Vill-Bagdanga, Joarder Para','','Present Address','4200','Ratanhut',1,474);
...
insert  into `sec_user_group_action`(`GROUP_ID`,`ACTION_ID`) values (4,7),(1,6),(1,7),(1,10),(1,8),(1,3);
...
insert  into `sec_user_master`(`type`,`id`,`active`,`name`,`applicant_id`,`cell`) values ('Staff',1,'','Khomeni',NULL,NULL),('Student',12,'','Habib Uddin Khan',17020001,'01717659287'),('Staff',15,'','Mr. User Eleven',NULL,NULL),('Staff',16,'','user22',NULL,NULL),('Staff',17,'','Mr. User Twelve',NULL,NULL),('Staff',18,'','Md.  Ayatullah',NULL,NULL),('Staff',19,'','Md. Rezaul Karim',NULL,NULL),('Staff',21,'','Md. Eleyas  Khandcker',NULL,NULL),('Staff',28,'','Md.  Ayatullah',NULL,NULL);
...
insert  into `staff_details`(`id`,`casm_user_oid`,`designation`,`ibbl_emp_id`,`last_logged`,`last_update`,`place_of_posting`,`br_code`,`staff`) values (2,'2015100511','R12','213576','2017-12-10 17:18:09','2017-12-10','H193','213',21);
