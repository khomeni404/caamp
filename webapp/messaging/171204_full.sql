...
CREATE TABLE `app_application` (
  ...
  `ben_status` varchar(255) DEFAULT NULL,
  `ben_type` varchar(255) DEFAULT NULL,
  ...
  `father_cell` varchar(255) DEFAULT NULL,
  ...
  `father_prof` varchar(255) DEFAULT NULL,
  `father_state` varchar(255) DEFAULT NULL,
...
insert  into `app_family_info`(`id`,`completed`,`earningMember`,`entryDate`,`familyMember`,`fatherCell`,`fatherCultivableLand`,`fatherEducation`,`fatherHouseLand`,`fatherLeasedLand`,`fatherOccupation`,`fatherState`,`guardianCellNo`,`guardianMonthIncome`,`guardianName`,`guardianOccupation`,`guardianRelation`,`houseType`,`managerRecommendType`,`maritalStatus`,`motherCell`,`motherEducation`,`motherOccupation`,`motherState`,`physicallyChalanged`,`physicallyChalangedType`,`residenceType`,`scholarshipFromIbbl`,`scholarshipFromOrg`,`scholarshipFromOther`,`scholarshipMonthlyAmt`,`siblingsInStudy`,`studentId`,`studentInfogenuine`,`totalSiblings`,`wardsOfFreedomFighter`,`applicantId`) values (1,'',NULL,'2017-12-03 11:24:31',NULL,'',NULL,'2506',NULL,NULL,'19','2602','Fate',NULL,'','19','',NULL,NULL,NULL,'','2503','11','2601',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'17020001',NULL,NULL,NULL,NULL);
...
CREATE TABLE `app_personal_info` (
  ...
  `completed` bit(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_n8padvenks62atwqyv1l0t88m` (`branch_br_code`),
  KEY `FK_l6ky7yalh5jkn2difqypmtdsk` (`district_id`),
  CONSTRAINT `FK_l6ky7yalh5jkn2difqypmtdsk` FOREIGN KEY (`district_id`) REFERENCES `com_district` (`id`),
  CONSTRAINT `FK_n8padvenks62atwqyv1l0t88m` FOREIGN KEY (`branch_br_code`) REFERENCES `ad_branch` (`br_code`)
...
insert  into `com_occupation`(`id`,`description`,`name`,`parent`,`name_bn`) values (1,NULL,'Govt. Service',NULL,NULL),(5,NULL,'Clerk',1,NULL),(8,NULL,'Self Employed',NULL,NULL),(9,NULL,'Barbar',8,NULL),(10,NULL,'Artist',8,NULL),(11,NULL,'Blacksmith',8,'&#2453;&#2494;&#2478;&#2494;&#2480;'),(18,NULL,'Lawyer',8,'&#2438;&#2439;&#2472;&#2460;&#2496;&#2476;&#2496;'),(19,NULL,'Postman',1,'&#2465;&#2494;&#2453;&#2474;&#2495;&#2527;&#2472;'),(20,NULL,'Duftry',1,'&#2470;&#2474;&#2509;&#2468;&#2480;&#2496;'),(21,NULL,'Non Gov. Service',NULL,'&#2476;&#2503;&#2488;&#2480;&#2453;&#2494;&#2480;&#2495; &#2458;&#2494;&#2453;&#2497;&#2480;&#2495;'),(22,NULL,'Teacher',NULL,'&#2486;&#2495;&#2453;&#2509;&#2487;&#2453;'),(23,NULL,'Teacher',21,'&#2486;&#2495;&#2453;&#2509;&#2487;&#2453;'),(24,NULL,'Peon',21,'&#2453;&#2480;&#2472;&#2495;&#2453;');
