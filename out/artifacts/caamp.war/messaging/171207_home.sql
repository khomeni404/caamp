...
insert  into `ad_designation`(`code`,`description`,`name`) values ('R10','--','Junor Officer'),('R11','--','Assistant Officer'),('R12','--','Trainee Officer');
...
insert  into `app_application`(`id`,`aiOK`,`applicantId`,`applyDate`,`eiOK`,`fiOK`,`oiOK`,`piOK`,`branch_br_code`,`district_id`,`familyInfo_id`,`personalInfo_id`,`project_code`,`student_id`,`closeDate`,`open`) values (4,'\0','17020024','2017-12-04 18:21:46','\0','','\0','','169',44,1,26,NULL,12,NULL,'');
...
insert  into `app_family_info`(`id`,`applicantId`,`completed`,`earningMember`,`entryDate`,`familyMember`,`fatherCell`,`fatherCultivableLand`,`fatherEducation`,`fatherHouseLand`,`fatherLeasedLand`,`fatherOccupation`,`fatherState`,`guardianCellNo`,`guardianMonthIncome`,`guardianName`,`guardianOccupation`,`guardianRelation`,`houseType`,`managerRecommendType`,`maritalStatus`,`motherCell`,`motherEducation`,`motherOccupation`,`motherState`,`physicallyChalanged`,`physicallyChalangedType`,`residenceType`,`scholarshipFromIbbl`,`scholarshipFromOrg`,`scholarshipFromOther`,`scholarshipMonthlyAmt`,`siblingsInStudy`,`studentInfogenuine`,`totalSiblings`,`wardsOfFreedomFighter`) values (1,NULL,'',NULL,'2017-12-06 15:28:03',NULL,'017845545545',NULL,'2501',NULL,NULL,'20','2602','021545454',NULL,'Habib Uddinn','18','Brother',NULL,NULL,NULL,'0121545','2506','24','2602',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
insert  into `app_personal_info`(`id`,`beneficiaryStatus`,`beneficiaryType`,`cellNo`,`completed`,`dob`,`educationLevelCode`,`emailAddress`,`entryDate`,`fatherName`,`motherName`,`nid`,`religion`,`sex`,`studentName`,`studentType`) values (26,NULL,NULL,'01717659287','','2017-12-01','','5656','2017-12-06','Jobbar','Paran Khatun','','2103','1502','Habib Uddin Khan','1701');
...
insert  into `com_address_master`(`type`,`id`,`line1`,`line2`,`note`,`pc`,`po`,`application_id`,`ps_id`) values ('Present',2,'Vill-Bagdanga, Joarder Para','','Present Address','4200','Ratanhut',4,310);
